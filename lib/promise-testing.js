...
function(){
    ...
    return function(){
        ...
        function addExecutableProperty(propName,constructor,recordExecution,execute){
            ...
            addProperty(propName,Constructor);
        }

        function ExecutableEchoPropertyExecute (lastResult,next){
        ...
        function EchoPropertyExecute (lastResult,next){
            var result = lastResult[this.propName];
            next(result);
        }

        function addEchoProperty(propName){
            addExecutableProperty(propName,null,false,EchoPropertyExecute);
        }

        function addExecutableEchoProperty(propName){
            addExecutableProperty(propName,null,true,ExecutableEchoPropertyExecute);
        }
